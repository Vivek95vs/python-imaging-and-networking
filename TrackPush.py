...
class DICOMPushGUI:
    ...
    def setup_push_tab(self, parent):
        ...
        search_frame.grid(row=3, column=0, columnspan=3, sticky=(tk.W, tk.E), pady=5)
        ...
        self.folder_tree = ttk.Treeview(tree_frame, columns=columns, show='tree headings', height=10)
        ...
        self.folder_tree.column('folder', width=350)
        ...
        sel_frame.grid(row=1, column=0, sticky=tk.W, pady=5)
        ...
        button_frame1.grid(row=8, column=0, columnspan=3, pady=5)
        ...
        button_frame2.grid(row=9, column=0, columnspan=3, pady=5)
    ...
    def extract_rtid_from_path(self, folder_path):
        """Extract RTID from folder path"""
        path_str = str(folder_path)
        # Look for RT followed by numbers/letters (e.g., RT202402A05)
        match = re.search(r'(RT\d+[A-Z]?\d*)', path_str)
        if match:
